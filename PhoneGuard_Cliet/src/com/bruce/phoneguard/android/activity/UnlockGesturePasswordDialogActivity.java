...
public class UnlockGesturePasswordDialogActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gesturepassword_unlock_dialog);
	...
	protected void onResume() {
		...
		if (!SysApplication.getInstance().getLockPatternUtils().savedPatternExists()) {
            ...
            overridePendingTransition(0,R.anim.close_from_bottom);
			finish();
		}
	}
	...
	protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
		...
		public void onPatternDetected(List<Cell> pattern) {
			...
			if (SysApplication.getInstance().getLockPatternUtils().checkPattern(pattern)) {
				...
				Intent intent = new Intent(UnlockGesturePasswordDialogActivity.this,
