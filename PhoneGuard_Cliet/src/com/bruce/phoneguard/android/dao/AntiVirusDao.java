...
public class AntiVirusDao {
	...
	public static String checkVirus(String md5) {
		String desc = null;
		// 打开病毒数据库
		SQLiteDatabase db = SQLiteDatabase.openDatabase(FescoConfig.FILES_PATH
				+ FescoConfig.ANTIVIRUS_DB, null, SQLiteDatabase.OPEN_READONLY);
	...
	public static boolean isDBExit() {
		File file = new File(FescoConfig.FILES_PATH + FescoConfig.ANTIVIRUS_DB);
	...
	public static void updateDBVersion(int newversion) {
		SQLiteDatabase db = SQLiteDatabase
				.openDatabase(
						FescoConfig.FILES_PATH + FescoConfig.ANTIVIRUS_DB,
