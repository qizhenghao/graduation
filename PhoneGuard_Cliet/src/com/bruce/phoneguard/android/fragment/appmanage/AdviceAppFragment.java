 ...
 */
public class AdviceAppFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private View mContentView;
    private ListView listView;
    private AppManagerAdapter adapter;
    private List<AppInfo> adviceTasks;
    ...
    public AdviceAppFragment(List<AppInfo> adviceTasks) {
    ...
    protected void initData() {
        if (adviceTasks == null) {
            adviceTasks = new ArrayList<AppInfo>();
        }
        adapter = new AppManagerAdapter(adviceTasks, getActivity());
    ...
    public void onRefresh(List<AppInfo> adviceTasks) {
        this.adviceTasks = adviceTasks;
        adapter.notifyDataSetInvalidated();
    }
