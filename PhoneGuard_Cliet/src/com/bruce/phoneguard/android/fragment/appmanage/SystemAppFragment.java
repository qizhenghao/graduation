 ...
 */
public class SystemAppFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{

    private View mContentView;
    private ListView listView;
    private AppManagerAdapter adapter;
    private List<AppInfo> systemTasks;
    ...
    public SystemAppFragment(List<AppInfo> systemTasks) {
    ...
    protected void initData() {
        if (systemTasks == null) {
            systemTasks = new ArrayList<AppInfo>();
        }
        adapter = new AppManagerAdapter(systemTasks, getActivity());
    ...
    public void onRefresh(List<AppInfo> systemTasks) {
        this.systemTasks = systemTasks;
        adapter.notifyDataSetInvalidated();
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ll_uninstall:
                    SystemInfoUtils.uninstallSysApp(mContext, clickedAppInfo.getApkpath());
                    break;
                case R.id.ll_start:
