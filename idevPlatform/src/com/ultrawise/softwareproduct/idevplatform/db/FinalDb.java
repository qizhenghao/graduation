 ...
 */
package com.ultrawise.softwareproduct.idevplatform.db;
...
import com.ultrawise.softwareproduct.idevplatform.db.sqlite.*;
import com.ultrawise.softwareproduct.idevplatform.db.table.KeyValue;
...
import com.ultrawise.softwareproduct.idevplatform.db.table.TableInfo;
...
public class FinalDb {
	 ...
	 *            排序字段
	 */
	public <T> T  findOneByWhere(Class<T> clazz, String strWhere) {
		checkTableExist(clazz);
		List<T> list = findAllByWhere(clazz, strWhere);
